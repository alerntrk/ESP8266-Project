...
static void task1_handler(void* parameters)
{
	...
	while(1)
	{
		ESP_GetData("0HZ0OKI6E3GVKF8P", Altin,Dolar);
	    taskYIELD();
	}
...
static void task2_handler(void* parameters)
{
	while(1)
	{
		...
		if(RX_BUFFER[0] == '1')
					  ...
					  SSD1306_Clear();
			  	  	  SSD1306_GotoXY(0,0);
			  	  	  SSD1306_Puts ("ALTIN", &myFont, color);
			  	  	  SSD1306_UpdateScreen();
			  	  	  SSD1306_GotoXY (0, 30);
			  	  	  SSD1306_Puts (Altin, &myFont, 1);
					  ...
					  SSD1306_Clear();
			  	  	  SSD1306_GotoXY(0,0);
			  	  	  SSD1306_Puts ("Dolar", &myFont, color);
			  	  	  SSD1306_UpdateScreen();
			  	  	  SSD1306_GotoXY (0, 30);
			  	  	  SSD1306_Puts (Dolar, &myFont, 1);
			  	  	  SSD1306_UpdateScreen(); //display
					    	}
...
int main(void)
{
	/* USER CODE BEGIN 1 */
	  ...
	  /* USER CODE BEGIN 2 */
	    ...
	    SSD1306_GotoXY (0,20);
	    SSD1306_Puts ("CONNECTING..", &Font_11x18, color);
	    SSD1306_UpdateScreen();
	    SSD1306_Clear();
	    BaseType_t status;
	    ...
	    ESP_Init("AndroidAP4F36", "eren434343");
